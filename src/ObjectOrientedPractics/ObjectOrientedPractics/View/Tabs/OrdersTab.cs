    ...
    public partial class OrdersTab : UserControl
    {
        ...
        public void RefreshData()
        {
            ...
            for (int i = 0; i < Customers.Count; i++)
            {
                ...
                {
                    _orders.Add(Customers[i].Orders[j]);
                }
            }         
        ...
        private void UpdateOrders()
        {
            ...
            for (int i = 0; i < _orders.Count; i++)
            {
                ...
                DataGridView.Rows[i].Cells["Address"].Value = $"{_orders[i].Address.Country}, " +
                    $"{_orders[i].Address.City}, " +
                    $"{_orders[i].Address.Street}, {_orders[i].Address.Building}, " +
                    $"{_orders[i].Address.Apartment}, {_orders[i].Address.PostalCode}";
                ...
                {
                    DataGridView.Rows[i].Cells["IsPriority"].Value = Resources.star_23;
                }
                else
                {
        ...
        private void OrdersTab_Load(object sender, EventArgs e)
        {
            ...
            AddressControl.AddressIsReadOnly(true);
        }
        ...
        private void StatusComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataGridView.Rows[DataGridView.CurrentRow.Index].Cells["OrderStatusColumn"].Value = 
