...
namespace ObjectOrientedPractics.Model
{
    ...
    { 
        ...
        private static string[] _names = 
            {
            "Ноутбук ASUS ExpertBook", 
            "Смартфон Apple iPhone 11", 
            "Ноутбук MSI GF76 Katana", 
            "Робот-пылесос Xiaomi Mi Robot Vacuum", 
            "Смартфон realme 9 Pro", 
        ...
        private static string[] _info = 
            { 
            "Cовременный ноутбук для корпоративных пользователей. " +
            ...
            "Быстрый процессор iPhone и мощный аккумулятор позволят больше делать " +
                "и тратить меньше времени на подзарядку. ", 
            "Этот игровой ноутбук создан для тех, кто хочет получить надежное и " +
            ...
            "Пылесос-робот Xiaomi Mi Robot Vacuum-Mop Essential – " +
                "интеллектуальный помощник для повседневной уборки", 
            "realme 9 Pro оснащен 6.6-дюймовым IPS-экраном " +
                "с разрешением Full HD+ и частотой обновления 120 Гц. ", 
            "Игры, созданные с помощью комплекта разработки " +
                "Xbox Series X|S, демонстрируют значительно сокращенное время загрузки и " +
                "потрясающие визуальные эффекты на скоростях до 120 к/с.",
            "iPhone 13. Самая совершенная система двух камер на iPhone.", 
            "Поддерживающая технологию Tempest 3D AudioTech игровая консоль PlayStation 5 " +
        ...
        public static Item Randomize()
        {
            ...
            Category category = (Category)_random.Next(1, 11);
